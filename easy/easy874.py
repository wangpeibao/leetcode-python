...
print(so.robotSim([4, -1, 3], []) == 25)
print(so.robotSim([4, -1, 4, -2, 4], [[2, 4]]) == 65)
a = [1, 2, -2, 5, -1, -2, -1, 8, 3, -1, 9, 4, -2, 3, 2, 4, 3, 9, 2, -1, -1, -2, 1, 3, -2, 4, 1, 4, -1, 1, 9, -1, -2, 5,
...
b = [[-57, -58], [-72, 91], [-55, 35], [-20, 29], [51, 70], [-61, 88], [-62, 99], [52, 17], [-75, -32], [91, -22],
